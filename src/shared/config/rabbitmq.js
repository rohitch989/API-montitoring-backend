...
class RabbitMQConnection {
  ...
  /**
   * this method create rabbit mq connection
   * @returns {RabbitMQConnection.channel}
   */
  async connect() {
  ...
  /**
   * this method return rabbitmq channel
   * @returns RabbitMQConnection.channel
   */
  getChannel = () => this.channel;

  /**
   * this method return  rabbitmq  status
   * @returns {string}
   */
  getStatus() {
  ...
  /**
   * this method closes the rabbitmq connection
   */
  async close() {
    try {
      if (this.channel) {
